\chapter{検証・評価}
本章では提案したDNA配列アラインメントスコア計算用の光Race Logic arrayについて機能検証と評価を行う．
\section{検証}
...
\includegraphics[keepaspectratio,scale=0.29]{fig/4/light_in_2_9.png}
\label{fig:test_in1}}
...
\caption{光Race Logic arrayの光伝搬出力信号強度$P_{out\,N,N}$}
\label{fig:nanopower}
\end{center}
\end{figure}
